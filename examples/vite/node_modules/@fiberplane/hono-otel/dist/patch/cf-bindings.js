import { getShouldTraceEverything } from "../config/index.js";
import { CF_BINDING_ERROR, CF_BINDING_METHOD, CF_BINDING_NAME, CF_BINDING_RESULT, CF_BINDING_TYPE, } from "../constants.js";
import { measure } from "../measure.js";
import { errorToJson, isObject, isUintArray, objectWithKey, safelySerializeJSON, } from "../utils/index.js";
/**
 ...
 */
export function patchCloudflareBindings(env) {
...
function isCloudflareBinding(o) {
    return (isCloudflareWorkerBinding(o) ||
...
function hasCloudflareD1Session(o) {
    return (objectWithKey(o, "alwaysPrimarySession") && isObject(o.alwaysPrimarySession));
}
