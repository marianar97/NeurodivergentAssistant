...
import { resolveOutputs, resolvePathAndMethod, resolveReference, resolveStepOutputs, resolveStepParams, } from "./resolvers.js";
// Test fixtures
...
describe("resolveReference", () => {
    ...
    it("should resolve step output references", () => {
        const result = resolveReference("$steps.createApp.outputs.appId", mockWorkflowContext);
    ...
    it("should handle template expressions", () => {
        const result = resolveReference("Bearer {$steps.createTokenForApp.outputs.token}", mockWorkflowContext);
        expect(result).toBe("Bearer fp_test_token_123");
    });
    it("should return undefined for invalid references", () => {
        const result = resolveReference("$steps.nonexistent.value", mockWorkflowContext);
