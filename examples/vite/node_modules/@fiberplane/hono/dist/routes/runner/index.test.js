...
vi.mock("./utils", () => ({
    getWorkflowById: vi.fn().mockImplementation(async (workflowId) => {
...
describe("Workflow Runner", () => {
    ...
    it("mock app should have executionCtx", async () => {
        const res = await app.request("/api/context-check", {}, {}, mockExecutionCtx);
    ...
    it("should handle workflow step failures", async () => {
        ...
        failureApp.use("/*", createFiberplane({
            app: failureApp,
            apiKey: mockApiKey,
            debug: true,
        }));
