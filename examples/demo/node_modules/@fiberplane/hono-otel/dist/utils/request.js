...
import { EXTRA_SEMATTRS_HTTP_REQUEST_METHOD, EXTRA_SEMATTRS_HTTP_RESPONSE_STATUS_CODE, EXTRA_SEMATTRS_URL_FULL, FPX_REQUEST_BODY, FPX_REQUEST_ENV, FPX_REQUEST_PATHNAME, FPX_REQUEST_SCHEME, FPX_REQUEST_SEARCH, FPX_RESPONSE_BODY, } from "../constants.js";
import { getNodeSafeEnv } from "./env.js";
 ...
 */
export async function getRootRequestAttributes(request, honoEnv) {
    let attributes = {};
...
export function getRequestAttributes(input, init) {
...
export async function getResponseAttributes(response) {
    const attributes = {
